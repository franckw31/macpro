...
<?php if(isset($_GET['debug']) && $_GET['debug'] === '1'){
	...
	?>
				...
				<div class="tile" id="profile-tile" role="button" tabindex="0" style="cursor:pointer">
		...
		<section class="card stroked" style="display:none" aria-hidden="true">
		   ...
		   <section class="card quick-action">
			   ...
			   <hr style="border:none;border-top:1px solid rgba(255,215,0,0.08);margin:8px 0">
				...
				document.addEventListener('DOMContentLoaded', function(){
					var p = document.getElementById('profile-tile');
					if(p){
						p.addEventListener('click', function(){
								var dest = '/panel/profile.php<?php echo (!empty($serverActivity['id'])? '?uid=' . intval($serverActivity['id']): ''); ?>';
	...
	<nav class="bottom-nav" role="navigation" aria-label="Main navigation">
		...
		<button id="nav-local" class="active" title="Local Timer">
		...
		<button id="nav-split" class="" title="Répartition">
