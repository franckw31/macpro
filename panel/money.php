...
// Load members list for admin selector (no pagination)
$members = [];
        ...
        <div class="card">
            <form method="get" action="money.php" style="display:flex;gap:8px;align-items:center;flex-wrap:wrap">
                ...
                <div style="display:flex;align-items:center;gap:8px">
                    ...
                    <span id="member_search_spinner" style="display:none;width:18px;height:18px;border:2px solid rgba(255,255,255,0.12);border-top-color:#08b0ff;border-radius:50%"></span>
                </div>
        ...
        <div class="card">
            <form method="post">
                ...
                <tr><th class="label">ID Participation</th><td><div style="display:flex;align-items:center;gap:8px">
                    ...
                    <button class="btn small" type="submit" name="submit_portefeuille" style="padding:4px 6px;vertical-align:middle">Ajouter Transaction</button>
                </div></td></tr>
        ...
        <table class="table">
            ...
            <?php foreach($transactions as $t){
                ...
                if ($mid > 0 && (in_array(intval($uid), [2,265], true) || intval($t['id_mvt_membre'] ?? 0) === intval($uid))) {
                    ...
                    echo '<input type="hidden" name="target_membre" value="' . intval($target_membre) . '">';
