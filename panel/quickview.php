...
<?php if(isset($_GET['debug']) && $_GET['debug'] === '1'){
	...
	?>
		<div class="tile" id="live-timer-tile" style="min-height:86px;display:flex;flex-direction:column;justify-content:flex-start;">
	...
	?>
				...
				<div class="tile" id="details-tile" role="button" tabindex="0" style="cursor:pointer;min-height:86px;display:flex;flex-direction:column;justify-content:flex-start;">
					<div class="tile-top"><div class="icon-circle info">i</div></div>
					<div class="tile-bottom">Détails Partie</div>
				</div>
				<a id="profile-tile" class="tile" role="link" href="/panel/profile.php<?php echo (!empty($serverActivity['id'])? '?uid=' . intval($serverActivity['id']): ''); ?>" style="text-decoration:none;color:inherit;min-height:86px;display:flex;flex-direction:column;justify-content:flex-start;">
				...
				?>
				<a id="participants-tile" class="tile" role="link" href="<?php echo htmlspecialchars($participants_href); ?>" style="text-decoration:none;color:inherit;min-height:86px;display:flex;flex-direction:column;justify-content:flex-start;">
