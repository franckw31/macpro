...
<div class="page">
  ...
  <div class="v2-card">
    ...
    <div class="v2-date-row">
      ...
      <button class="v2-cal-btn" id="v2-cal-open" title="Choisir une partie" aria-haspopup="dialog" style="width:46px;height:46px;border-radius:12px;background:rgba(10,132,255,0.18);border:2px solid #e03030;box-shadow:0 0 8px rgba(224,48,48,0.4);display:flex;align-items:center;justify-content:center;flex-shrink:0;margin-top:-18px">
