...
=======
	...
	@media (max-width: 480px) {
		.cardevent-circle-container { width: 60px !important; height: 60px !important; }
		.cardevent-content #live-cardevent-display { font-size: 16px !important; }
		.cardevent-content #live-cardevent-level, .cardevent-content #live-cardevent-blinds { font-size: 10px !important; }
	...
	@media (max-width: 360px) {
		.cardevent-circle-container { width: 52px !important; height: 52px !important; }
		.chev { width: 36px; height: 36px; font-size: 16px; }
		.cardevent-content #live-cardevent-display { font-size: 14px !important; }
