...
.v2-list-item{position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:12px;min-height:170px;padding:20px 18px 18px;background:#1f1f22;border:1px solid rgba(255,255,255,0.04);border-radius:26px;text-decoration:none;color:#f4f4f6;transition:transform .16s ease,background .16s ease,border-color .16s ease,box-shadow .16s ease;text-align:center;overflow:hidden}
...
.v2-list-name{font-size:17px;line-height:1.12;font-weight:800;letter-spacing:-0.02em;margin:0;color:#fff}
.v2-list-sub{font-size:12px;line-height:1.3;color:rgba(255,255,255,0.48);margin-top:6px;font-weight:500}
...
@media(min-width:390px){.v2-list-name{font-size:18px}.v2-list-sub{font-size:12.5px}}
