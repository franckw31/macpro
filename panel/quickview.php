		   ...
		   <section class="card quick-action">
			   ...
			   <hr style="border:none;border-top:1px solid rgba(255,215,0,0.08);margin:8px 0">
						 <div style="display:flex;align-items:center;justify-content:space-between">
							 ...
							 <div>
								<button id="reg-action" class="button primary" style="margin-left:auto;padding:8px 12px;border-radius:10px;font-weight:700"><?php echo (!empty($serverParticipation) && isset($serverParticipation['status']) && !in_array($serverParticipation['status'], array('None','Desinscrit'))) ? 'Modifier' : 'S Inscrire'; ?></button>
							 </div>
						 <div>
