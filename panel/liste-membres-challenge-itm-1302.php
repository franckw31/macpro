...
$where_clause_current = $currentChallengeId > 0 ? "WHERE c.id_challenge = $currentChallengeId" : "";
if ($where_clause_current) {
    $where_clause_current .= " AND a.date_depart < '$today'";
} else {
    $where_clause_current = "WHERE a.date_depart < '$today'";
}
