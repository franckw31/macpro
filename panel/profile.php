    ...
    <div class="sheet">
        ...
        <div class="card" style="padding:12px">
            ...
            <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:8px;margin-top:12px">
                ...
                <div style="text-align:center"><div class="num" style="color:#ff9d3b"><a href="/panel/activities_wins.php?uid=<?php echo intval($uid_int); ?>" style="color:inherit;text-decoration:underline;text-decoration-color:#08b0ff"><?php echo intval($stats['gains']); ?></a></div><div class="sub">ITM <span style="font-size:11px;color:#9aa6b1">(<?php echo $podium_pct; ?>%)</span></div></div>
