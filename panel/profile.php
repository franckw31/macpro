...
<body>
    <div class="sheet" style="position:relative">
        ...
        <div class="card">
            ...
            <div class="card-row"><div class="label">Solde actuel</div><div class="value"><span style="color:<?php echo $sol_color; ?>"><?php echo fmt_money(intval(round($sol_val))); ?></span> <a href="/panel/money.php" style="margin-left:8px;color:#08b0ff;font-weight:700">Mouvements</a></div></div>
            ...
            <div class="card-row"><div class="label">SergioScore</div><div class="value"><?php
                $sergio_avg = null;
                if (!empty($con) && !empty($uid_int)) {
                    $sq = @mysqli_query($con, "SELECT ROUND(AVG(p.sergio_score),1) AS avg FROM participation p WHERE p.`id-membre`='".intval($uid_int)."' AND p.sergio_score IS NOT NULL");
