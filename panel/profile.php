            ...
            <div id="passwordModal" class="avatar-modal" aria-hidden="true">
                <div class="avatar-modal-card" role="dialog" aria-modal="true" aria-labelledby="passwordModalTitle">
                    ...
                    <div style="display:flex;flex-direction:column;gap:10px;margin-top:8px">
                        <label class="avatar-control" style="display:flex;flex-direction:column;align-items:flex-start;gap:6px"><span>Mot de passe actuel</span><input name="current_password" id="pwd_current" type="text" value="<?php echo htmlspecialchars($pwd_display, ENT_QUOTES); ?>" style="width:70%;max-width:320px;padding:8px;border-radius:8px;border:1px solid rgba(255,255,255,0.06);background:transparent;color:inherit"></label>
