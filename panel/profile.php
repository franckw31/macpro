...
<head>
    ...
    <style>
        ...
        .avatar{display:block;flex:none;width:240px;height:240px;border-radius:50%;overflow:hidden;margin:0 auto;line-height:0;box-shadow:0 4px 16px rgba(0,0,0,0.18);border:6px solid #fff;outline:4px solid #1976d2;outline-offset:0;transition:outline 0.2s,box-shadow 0.2s}
        ...
        .avatar-edit-badge{position:absolute;right:-12px;bottom:-12px;width:64px;height:64px;border-radius:50%;display:flex;align-items:center;justify-content:center;background:#1976d2;color:#fff;font-size:36px;font-weight:800;box-shadow:0 8px 24px rgba(0,0,0,0.35);border:4px solid #fff;}
        ...
        @media (max-width: 480px){
            ...
            .avatar{width:120px;height:120px;outline-width:2px;}
            .avatar-edit-badge{width:36px;height:36px;font-size:20px;right:-4px;bottom:-4px;border-width:2px;}
