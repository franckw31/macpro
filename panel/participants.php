...
(function(){
    ...
    function render(arr){
        ...
        listEl.innerHTML = arr.map((p,i)=>{
          ...
          const tombolasChk = `<label title="Tombolas" style="display:inline-block;margin-left:8px"><input type=\"checkbox\" ${p.tombolas==1 ? 'checked' : ''} onchange=\"toggleTombolas(${p.mid}, ${ACT_ID}, this)\" /></label>`;
