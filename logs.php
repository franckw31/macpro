...
$count_nouvelle_inscription = (int)mysqli_fetch_row(mysqli_query($conx, "SELECT COUNT(*) FROM activity_logs WHERE $where AND action = 'nouvelle_inscription'"))[0];
...
<h1>Logs d'activite <span style="font-size:14px;color:var(--muted);font-weight:normal;margin-left:10px">(<?php echo $unique_logged_users; ?> utilisateurs uniques dans les logs | <?php echo $count_nouvelle_inscription; ?> nouvelles inscriptions)</span></h1>
