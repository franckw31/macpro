...
<h1>Logs d'activite <span style="font-size:14px;color:var(--muted);font-weight:normal;margin-left:10px">(<?php echo $unique_logged_users; ?> utilisateurs uniques dans les logs)</span></h1>
