...
final class AuthService: ObservableObject {
    ...
    func login(username: String, password: String) async {
        ...
        do {
            ...
            pseudo = name; isAdmin = adminFlag == "1"; isAuthenticated = true
    ...
    private func clearCredentials() {
        KeychainHelper.delete(forKey: tokenKey); KeychainHelper.delete(forKey: pseudoKey); KeychainHelper.delete(forKey: adminKey); pseudo = ""; isAdmin = false; isAuthenticated = false
    }
