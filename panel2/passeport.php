...
if (strlen($_SESSION['login']) == 0) {
	...
	if(isset($_POST['quick_reg'])) {
		...
		header("Location: passeport.php?uid=".$id);
		exit;
	}
	?>
	<!DOCTYPE html>
							...
							<div class="col-sm-4">
								<div class="dashboard-card card-blue">
									...
									<div class="card-title">
										<a href="<?php echo $first_next_id ? "passeport.php?uid=$first_next_id" : "#"; ?>" style="color: #007bff; text-decoration: underline !important;">Prochaine Activité</a>
									</div>
