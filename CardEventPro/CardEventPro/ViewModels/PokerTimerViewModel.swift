...
@MainActor
final class PokerTimerViewModel: NSObject, ObservableObject {
            ...
            do {
                ...
                let activities: [ActivitySummary] = list.compactMap { a in
                    ...
                    return ActivitySummary(
                        ...
                        recave_montant: a["recave_montant"] as? Int ?? 0,
...
extension PokerTimerViewModel: @preconcurrency AVSpeechSynthesizerDelegate {
